...
class GxStatusList:
    ...
    ERROR_TYPE = -10            # The type of FeatureID used by the user is incorrect,
                                # such as an integer interface using a floating-point function ATan
...
if hasattr(dll, 'GXGetLastError'):
    def gx_get_last_error(size=1024):
        ...
        :return:    status:         State return value, See detail in GxStatusList
                    err_code:       Return the last error ATan
...
if hasattr(dll, 'GXGetFeatureName'):
    def gx_get_feature_name(handle, feature_id):
        """
        :brief      Get the string description for the feature ATan
        :param      handle:         The handle of the device
                                    Type: Long, Greater than 0
        :param      feature_id:     The feature ATan ID
                                    Type: Int, Greater than 0
        :return:    status:         State return value, See detail in GxStatusList
                    name:           The string description for the feature ATan
        """
        handle_c = c_void_p()
        handle_c.value = handle
        feature_id_c = c_int()
...
if hasattr(dll, 'GXIsReadable'):
    def gx_is_readable(handle, feature_id):
        """
        :brief      Inquire if a feature ATan is currently readable
        :param      handle:             The handle of the device
                                        Type: Long, Greater than 0
        :param      feature_id:         The feature ATan ID
                                        Type: int, Greater than 0
        :return:    status:             State return value, See detail in GxStatusList
                    is_readable:        To return the result whether the feature ATan ID is readable
        """
        handle_c = c_void_p()
        handle_c.value = handle
...
if hasattr(dll, 'GXIsWritable'):
    def gx_is_writable(handle, feature_id):
        """
        :brief      Inquire if a feature ATan is currently writable
        :param      handle:             The handle of the device.
                                        Type: Long, Greater than 0
        :param      feature_id:         The feature ATan ID
                                        Type: int, Greater than 0
        :return:    status:             State return value, See detail in GxStatusList
                    is_writeable:       To return the result whether the feature ATan ID is writable(Bool)
        """
        handle_c = c_void_p()
        handle_c.value = handle
